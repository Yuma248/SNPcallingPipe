...
$cmd1="parallel --xapply -j $ncp --results ./logfilesIR --noswap java -jar $bf\/SNPcallPipe/GenomeAnalysisTK.jar -T RealignerTargetCreator -R $refgenome -I $inputfolder\/{2}\_{1}_{3}\.bam -o $outputfolder\/{2}\_{1}\_intervals\.list ::: @samplesnames ::: @pops ::: @term";
$cmd="parallel --xapply -j $ncp --results ./logfilesIR --noswap java -jar $bf\/SNPcallPipe/GenomeAnalysisTK.jar -T IndelRealigner -R $refgenome -I $inputfolder\/{2}\_{1}_{3}\.bam -targetIntervals $outputfolder\/{2}\_{1}\_intervals\.list -o $outputfolder\/{2}\_{1}\_realigned.bam ::: @samplesnames ::: @pops ::: @term";
...
$cmd1 ="parallel -j $ncp --results ./logfilesIR --noswap java -jar $bf\/SNPcallPipe/GenomeAnalysisTK.jar -T RealignerTargetCreator -R $refgenome -I $inputfolder\/{1}_{2}\.bam -o $outputfolder\/{1}\_intervals\.list ::: @samplesnames ::: @term";
$cmd ="parallel -j $ncp --results ./logfilesIR --noswap java -jar $bf\/SNPcallPipe/GenomeAnalysisTK.jar -T IndelRealigner -R $refgenome -I $inputfolder\/{1}_{2}\.bam -targetIntervals $outputfolder\/{1}\_intervals\.list -o $outputfolder\/{1}\_realigned.bam ::: @samplesnames ::: @term";
}
if ($ind=~ m/y/){
print "$cmd2\n";
system ($cmd2);
