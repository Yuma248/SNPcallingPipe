...
#		print "This is the $outfiles[0] and $outfiles[1]\n\n\n";
 	 											...
 	 											`zcat $outdDocent/pop$hash_pop{$s_name}\_$s_name.R.fq.gz \| perl -pe  \'s/\\/2\\/2/\\/2/g\' \| gzip  \'>\' $outdDocent/pop$hash_pop{$s_name}\_$s_name.Ra.fq.gz`;												
												`zcat $outdDocent/pop$hash_pop{$s_name}\_$s_name.F.fq.gz \| perl -pe  \'s/\\/1\\/1/\\/1/g\' \| gzip  \'>\' $outdDocent/pop$hash_pop{$s_name}\_$s_name.Fa.fq.gz`;
												`rm $outdDocent/pop$hash_pop{$s_name}\_$s_name.[F R].fq.gz`;
